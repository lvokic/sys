...
public:
  ...
  FieldExpr(const BaseTable *table, const FieldMeta *field) : field_(table, field), table_name_(table->name()), field_name_(field->name()) {}
...
public:
  ...
  {
    switch (func_type_) {
      case SysFuncType::SYS_FUNC_LENGTH: 
        return INTS;
        break;
      case SysFuncType::SYS_FUNC_ROUND:
        return FLOATS;
        break;
      case SysFuncType::SYS_FUNC_DATE_FORMAT:
        return CHARS;
        break;
      default:
        break;
