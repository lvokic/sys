...
public:
  ...
  public:
    ...
    void finish() 
    {
      if (expr_->get_aggr_func_type() == AggrFuncType::AGG_COUNT) {
...
public:
  ...
  RC find_cell(const TupleCellSpec &spec, Value &cell,int &index) const override { return RC::INVALID_ARGUMENT; }
